            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div id="inputconD" class="exampleD">
                            ...
                            @foreach ($SD as $i=>$Dhigh )
                                ...
                                @endif
                            <div class="mb-3">
                                <input type="text" value="{{ $Dhigh }}" class="form-control" id="inputIDD{{$i}}"
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        @endif --}}
                            ...
                            <button id="row-D" type="button" class="btn btn-primary">Add row</button>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div id="inputconI" class="exampleI">
                            ...
                            @foreach ($SI as $i=>$Ihigh )
                                ...
                                @endif
                            <div class="mb-3">
                                <input type="text" value="{{ $Ihigh }}" class="form-control" id="inputIDI"
                                {{-- id="I_High{{ $i+1 }}" --}}
                                    placeholder="soalan" name="value[]">
                        ...
                        @endif --}}
                        <button id="row-I" type="button" class="btn btn-primary">Add row</button>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div id="inputconS" class="exampleS">
                            ...
                            @foreach ($SS as $i=>$Shigh )
                                ...
                                @endif
                            <div class="mb-3">
                                <input type="text" value="{{ $Shigh }}" class="form-control" id="inputIDS"
                                    placeholder="soalan" name="value[]">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button id="row-S" type="button" class="btn btn-primary">Add row</button>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div id="inputconC" class="exampleC">
                            ...
                            @foreach ($SC as $i=>$Chigh )
                                ...
                                @endif
                            <div class="mb-3">
                                <input type="text" value="{{ $Chigh }}" class="form-control" id="inputIDC"
                                    placeholder="soalan" name="value[]">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button id="row-C" type="button" class="btn btn-primary">Add row</button>
...
{{-- <x-t_function/> --}}
    ...
    <script src="{{ URL::asset('assets/js/str.js') }}"></script>
