...
@section('content')
    ...
    <div class="container page-break">
        ...
        @switch($High)
            @case('D')
                <img src="{{ public_path('assets/img/report/inv/D.png') }}" width="800px" height="1122px">
            @break

            @case('I')
                <img src="{{ public_path('assets/img/report/inv/I.png') }}" width="800px" height="1122px">
            @break

            @case('S')
                <img src="{{ public_path('assets/img/report/inv/S.png') }}" width="800px" height="1122px">
            @break

            @case('C')
                <img src="{{ public_path('assets/img/report/inv/CC.png') }}" width="800px" height="1122px">
            @break
        ...
        <img class="top-center" src="{{ $personalchart }}" alt="chart">

        @switch($High)
            @case('D')
            <div class="box-number" style="color: #004aad"><span class="big-text">{{$percent}}%</span></div>

            @break

            @case('I')
            <div class="box-number" style="color: #1c8638"><span class="big-text">{{$percent}}%</span></div>
            ...
            @case('C')
            <div class="box-number" style="color: #d54ce6"><span class="big-text">{{$percent}}%</span></div>
            @break
